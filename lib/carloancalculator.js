...
class carloancalculator_Calc {
	...
	calcPay(principal,annualInterestRatePercent,paymentsPerYear,totalPayments,frequencyString) {
...
$hxClasses["carloancalculator.Calc"] = carloancalculator_Calc;
carloancalculator_Calc.__name__ = "carloancalculator.Calc";
Object.assign(carloancalculator_Calc.prototype, {
	__class__: carloancalculator_Calc
});
class carloancalculator_CarLoanCalculator {
	constructor(maglev) {
		this.maglev = maglev;
		this.calc = new carloancalculator_Calc();
		this.registerMyMethods();
	}
	registerMyMethods() {
		let _gthis = this;
		this.maglev.register("CarLoanCalculator.CalcPayments",maglev_MagLevFunction.fromFunction(function(args) {
			let newCarPrice = (js_Boot.__cast(args.get(0) , maglev_MagLevNumber)).getFloat();
			let tradeInAllowance = (js_Boot.__cast(args.get(1) , maglev_MagLevNumber)).getFloat();
			let tradeInLoanBalance = (js_Boot.__cast(args.get(2) , maglev_MagLevNumber)).getFloat();
			let downPaymentAndRebates = (js_Boot.__cast(args.get(3) , maglev_MagLevNumber)).getFloat();
			let loanDuration = (js_Boot.__cast(args.get(4) , maglev_MagLevNumber)).getFloat();
			let salesTaxRate = (js_Boot.__cast(args.get(5) , maglev_MagLevNumber)).getFloat();
			let interestRate = (js_Boot.__cast(args.get(6) , maglev_MagLevNumber)).getFloat();
			let payments = _gthis.calc.calcPayments(newCarPrice,tradeInAllowance,tradeInLoanBalance,downPaymentAndRebates,loanDuration,salesTaxRate,interestRate);
			let arr = maglev_MagLevArray.create();
			let _g = 0;
			while(_g < payments.length) {
				let payment = payments[_g];
				++_g;
		...
		this.maglev.register("CarLoanCalculator.CalcAffordability",maglev_MagLevFunction.fromFunction(function(args) {
			let monthlyPayment = (js_Boot.__cast(args.get(0) , maglev_MagLevNumber)).getFloat();
			let tradeInAllowance = (js_Boot.__cast(args.get(1) , maglev_MagLevNumber)).getFloat();
			let tradeInLoanBalance = (js_Boot.__cast(args.get(2) , maglev_MagLevNumber)).getFloat();
			let downPaymentAndRebates = (js_Boot.__cast(args.get(3) , maglev_MagLevNumber)).getFloat();
			let loanDuration = (js_Boot.__cast(args.get(4) , maglev_MagLevNumber)).getFloat();
			let salesTaxRate = (js_Boot.__cast(args.get(5) , maglev_MagLevNumber)).getFloat();
			let interestRate = (js_Boot.__cast(args.get(6) , maglev_MagLevNumber)).getFloat();
			let result = _gthis.calc.calcAffordability(monthlyPayment,tradeInAllowance,tradeInLoanBalance,downPaymentAndRebates,loanDuration,salesTaxRate,interestRate);
			let obj = maglev_MagLevObject.create();
